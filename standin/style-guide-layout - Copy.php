...
<aside class="d-sidebar">
  ...
  <div class="d-nav-group">
    ...
    <div class="d-nav-item" data-target="shadow-system">Shadow</div>
    <div class="d-nav-item" data-target="width-system">Width</div>
    <div class="d-nav-item" data-target="height-system">Height</div>
    <div class="d-nav-item" data-target="position-system">Position</div>
    <div class="d-nav-item" data-target="display-system">Display</div>
    <div class="d-nav-item" data-target="grid-system">Display Grid</div>
    <div class="d-nav-item" data-target="flex-system">Display Flex</div>
    <div class="d-nav-item" data-target="offset-system">Offset</div>
    <div class="d-nav-item" data-target="image-system">Image</div>
    <div class="d-nav-item" data-target="overflow-system">Overflow</div>
    <div class="d-nav-item" data-target="z-index-system">Z-Index</div>
  </div>
  <div class="d-nav-group">
