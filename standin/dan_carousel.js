  ! function(n, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (n = "undefined" != typeof globalThis ? globalThis : n || self).DanCarousel = t()
  }(this, (function() {
    "use strict";
        ...
        init: function(n) {
          ...
          function o(o) {
            (e(D) || D(n, o)) && function(n) {
              ...
              N = !0, a.pointerDown(n), p.useFriction(0).useDuration(0), s.set(d),
                function() {
                  const n = G ? r : t;
    ...
    function P(n, e, r, f, p, m, P) {
      const {
      ...
      }(Z, J, K, r, rn, p), an = O(Z, _, G, B, J, K, un, sn, 2), {
        snaps: dn,
        snapsAligned: ln
      } = function(n, t, e, r, i) {
        const {
          ...
          groupSlides: a
        } = i, d = a(r).map((n => s(n)[u] - n[0][c])).map(o).map(t.measure), l = r.map((n => e[c] - n[c])).map((n => -o(n))), f = a(l).map((n => n[0])).map(((n, t) => n + d[t]));
        return {
          snaps: l,
          snapsAligned: f
        }
      }(Z, tn, J, K, an), fn = -s(dn) + s(cn), {
        snapsContained: pn,
      ...
      }(fn, gn, B), xn = y(a(gn), V, B), yn = xn.clone(), vn = u(r), bn = h(f, p, (() => (({
        dragHandler: n,
        scrollBody: t,
        scrollBounds: e,
        options: {
        ...
        return h
      }(wn, Ln, En, Dn, C, .68), Mn = L(B, gn, fn, hn, Dn), An = function(n, t, e, r, o, i, c) {
        function u(o) {
          const u = o.distance,
            s = o.index !== t.get();
      ...
      }(bn, xn, yn, In, Mn, Dn, P), Fn = function(n) {
        const {
          max: t,
          length: e
        } = n;
      ...
      }(en, U, gn, mn, an, vn), zn = D(n, r, Pn, An, In, Tn, P, X), Hn = {
        ownerDocument: f,
        ownerWindow: p,
        eventHandler: P,
        containerRect: J,
...
S = [].slice.call(
  i || b.children)
    ...
    function readSliderOptions(slider){

  return {

    loop:
      slider.classList.contains('loop'),

    dragFree:
      slider.classList.contains('drag-free'),

    skipSnaps:
      slider.classList.contains('skip-snaps'),
...
containScroll:
  ...
  slider.classList.contains(
    ...
    direction:
      slider.classList.contains('rtl')
      ? 'rtl'
      : 'ltr',

    axis:
      slider.classList.contains('vertical')
      ? 'y'
      : 'x'
...
function readSliderPlugins(slider){
...
if(
  ...
  ! function(n, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (n = "undefined" != typeof globalThis ? globalThis : n || self).DanCarouselAutoplay = t()
  }(this, (function() {
    "use strict";
    const n = {
      active: !0,
    ...
    function t(o = {}) {
      ...
      function d() {
        s || (g() ? p = !0 : (a || i.emit("autoplay:play"), function() {
          const {
            ownerWindow: n
          } = i.internalEngine();
          n.clearTimeout(u), u = n.setTimeout(E, l[i.selectedScrollSnap()]), r = (new Date).getTime(), i.emit("autoplay:timerset")
        }(), a = !0))
      }

      function m() {
        s || (a && i.emit("autoplay:stop"), function() {
          const {
            ownerWindow: n
          } = i.internalEngine();
          n.clearTimeout(u), u = 0, r = null, i.emit("autoplay:timerstopped")
        }(), a = !1)
      }
      ...
      function E() {
        const {
          index: n
        } = i.internalEngine(), t = n.clone().add(1).get(), o = i.scrollSnapList().length - 1, s = e.stopOnLastSnap && t === o;
        if (i.canScrollNext() ? i.scrollNext(f) : i.scrollTo(0, f), i.emit("autoplay:select"), s) return m();
        d()
      }
      return {
        name: "autoplay",
        ...
        init: function(r, u) {
          ...
          const {
            mergeOptions: a,
            optionsAtMedia: c
          } = u, p = a(n, t.globalOptions), g = a(p, o);
          ...
          const {
            eventStore: E,
            ownerDocument: I
          } = i.internalEngine(), h = !!i.internalEngine().options.watchDrag, T = function(n, t) {
            const o = n.rootNode();
            return t && t(o) || o
          }(i, e.rootNode);
          E.add(I, "visibilitychange", y), h && i.on("pointerDown", O), h && !e.stopOnInteraction && i.on("pointerUp", S), e.stopOnMouseEnter && E.add(T, "mouseenter", w), e.stopOnMouseEnter && !e.stopOnInteraction && E.add(T, "mouseleave", b), e.stopOnFocusIn && i.on("slideFocusStart", m), e.stopOnFocusIn && !e.stopOnInteraction && E.add(i.containerNode(), "focusout", d), e.playOnInit && d()
        },
        destroy: function() {
          i.off("pointerDown", O).off("pointerUp", S).off("slideFocusStart", m), m(), s = !0, a = !1
        },
        play: function(n) {
          void 0 !== n && (f = n), d()
        },
