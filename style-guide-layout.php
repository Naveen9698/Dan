...
<aside class="w-10p w-add-5p bg-white of-y-auto h-100vh pn-sticky t-0" data-ut="guide-nav">
  ...
  <div class="pa-xs flex-y">
    ...
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#getting-started">Getting Started</a>
    ...
    <!-- <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Interaction</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Layout</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Behavior</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Autoplay</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Components</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Effects</a>
    <a class="fz-14 clr-g8 px-xs py-xxs ra-xxs" href="#">Advanced</a>
