<h2 class="fz-28 fw-700 clr-g9 bg-g2 txt-center pa-xs" id="cursor-system">Cursor System</h2>
...
<section class="px-md stack-y-sm">
  ...
  <div class="flex-x gap-md f-wrap">
    <pre class="bg-g9 clr-white ra-sm pa-xs fz-12 lh-16"><code><?php include 'class/cursor.php'; ?></code></pre>
  </div>

  <h3>Helper Classes</h3>

  <div class="flex-x gap-md f-wrap">
    <pre class="bg-g9 clr-white ra-sm pa-xs fz-12 lh-16"><code><?php include 'class/cursor-helper.php'; ?></code></pre>
  </div>
