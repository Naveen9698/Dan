<div class="grid gap-sm">
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-sm pa-sm">
    ...
    <div class="grid gap-sm mb-sm">
      ...
      <span class="g-12 fs-14 fw-600 clr-g8">Height (px)</span>

      <div class="g-4">
        <div class="bg-main clr-white pa-xs h-90px sw-lg ta-center">
          h-90px <br> <br> 90px
        </div>
      </div>

      <div class="g-4">
        <div class="bg-main clr-white pa-xs h-90px h-add-9px sw-lg ta-center">
          h-90px <br> h-add-9px <br><br> 99px
        </div>
      </div>

      <div class="g-4">
        <div class="bg-main clr-white pa-xs h-100px h-add-90px h-add-9px sw-lg ta-center">
          h-100px <br> h-add-90px <br> h-add-9px <br><br> 199px
        </div>
      </div>
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-sm pa-sm">
    ...
    <div class="grid gap-sm mb-sm">
      ...
      <span class="g-12 fs-14 fw-600 clr-g8">Height (vh)</span>

      <div class="g-4">
        <div class="bg-sub clr-white pa-xs h-9vh sw-lg ta-center">
          h-9vh
        </div>
      </div>

      <div class="g-4">
        <div class="bg-sub clr-white pa-xs h-20vh sw-lg ta-center">
          h-20vh
        </div>
      </div>

      <div class="g-4">
        <div class="bg-sub clr-white pa-xs h-10vh h-add-9vh sw-lg ta-center">
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-sm pa-sm">
    ...
    <div class="grid gap-sm mb-sm">
      ...
      <span class="g-12 fs-14 fw-600 clr-g8">Height (%)</span>

      <div class="g-4">
        <div class="h-200px sw-sm">
          <div class="bg-acnt clr-white pa-xs h-50p sw-lg ta-center">
            h-200px <br>
            h-50p <br><br> 50%
          </div>
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-md pa-md">
    <span class="fs-14 fw-600 clr-g8">Overflow Behavior</span>
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-md pa-md">
    <span class="fs-14 fw-600 clr-g8">Max Height</span>
  ...
  <div class="g-4 flex-y gap-xxs bg-white ra-md pa-md">
    <span class="fs-14 fw-600 clr-g8">Min Height</span>
