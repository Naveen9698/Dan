<div class="yd_carousel group-snap pn-relative loop keyboard autoplay">
  ...
  <div class="yd_viewport of-hidden">
    <div class="yd_container slides-3">
      <div class="yd_slide px-sm blur-lg ac:blur-0">
  ...
  <div class="yd_controles">
    <button class="yd_prev bg-g5 clr-white pn-absolute w-100p t-50p tt-50p ba-0 l--20px w-fit px-sm py-xs"> Prev </button>
    <button class="yd_next bg-g5 clr-white pn-absolute w-100p t-50p tt-50p ba-0 r--20px w-fit px-sm py-xs"> Next </button>
    ...
    <div class="yd_scrollbar">
      <div class="yd_scrollbar-thumb"></div>
    </div>
  </div>
...
<div class="yd_carousel pn-relative">
  ...
  <div class="yd_controles">
    ...
    <div class="yd_autoplay-progress"></div>
